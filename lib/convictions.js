export const convictions = [
  {
    ...
    allocation: 'Exited (profit)',
    statusNote: 'Position fully exited (Aug 2026).',
  },
  {
    ticker: 'PATH',
    name: 'UiPath',
    ...
    allocation: 'Exited (profit)',
    statusNote: 'Exited with a profit (Aug 2026).',
  },
  {
    ticker: 'KLAR',
    name: 'Klarna',
    ...
    allocation: 'Accumulating (target ~4-5%)',
    statusNote:
      'Actively accumulating (Aug 2026), building toward the ~4-5% target.',
  },
  {
    ticker: 'TOST',
    name: 'Toast',
    ...
    statusNote: 'Selling a covered call — $40 strike (Aug 2026).',
  },
  {
    ticker: 'TEAM',
    name: 'Atlassian',
    ...
    statusNote:
      'Selling a covered call — $250 strike, Jan 2028 expiry (Aug 2026).',
  },
  {
    ticker: 'UBER',
    name: 'Uber',
    ...
    allocation: 'Planned up to ~8%',
    statusNote:
      'Long-term bullish — plan to keep holding and adding through volatility (Aug 2026).',
  },
  {
    ticker: 'MSFT',
    name: 'Microsoft',
    tag: 'Cloud & AI Infrastructure',
    summary: 'Every body knows MSFT',
    bullets: [
      'Sticky Product',
      '27% stake in openAI',
      '4-8% reported stake in Anthropic',
    ],
    risks: ['capex spending'],
    allocation: '~8% (current)',
    statusNote:
      'Current holding is ~8% of portfolio (Aug 2026), above the original ~4% plan.',
  },
];

export const otherConvictions = {
  broaderThesis: {
  ...
  bonds: {
    title: 'Bonds',
    items: [
      { ticker: 'JAAA', name: 'Janus Henderson AAA CLO ETF' },
